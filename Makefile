...
SRCNAM		= ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isblank.c ft_isspace.c \
			  ...
			  ft_sputwstr.c ft_sputnwstr.c ft_size_wchar.c \
			  ft_base.c get_next_line.c

SRC			= $(SRCNAM:%=$(SRCDIR)/%) $(LSTSRC) $(PRISRC) $(MEMSRC) $(STRSRC)
OBJ			= $(SRC:%.c=%.o)
